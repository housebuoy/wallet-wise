      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            ...
            <Link to="/features" className="text-gray-600 hover:text-walletwise-purple px-3 py-2 rounded-md text-md font-medium">
              Features
            </Link>
            <Link to="/about" className="text-gray-600 hover:text-walletwise-purple px-3 py-2 rounded-md text-md font-medium">
              About Us
            </Link>
